...
| **`harmonicTilt`** | Spectral tilt control for harmonic partials. Range: -1.0 to 1.0. Positive values reduce higher partials (darker tone), negative values emphasize higher partials (brighter tone). | `0.0` |
| **`harmonicOddEvenBalance`** | Crossfades between odd and even partial emphasis. Range: 0.0 to 1.0. `0.0` emphasizes odd partials, `1.0` emphasizes even partials, `0.5` is balanced. | `0.5` |
...
| **`harmonicPartial1Level`** … **`harmonicPartial64Level`** | Per-partial amplitude controls for partials 1–64. Each level is a floating-point value from 0.0 to 1.0. | `0.0` |
